...
struct QHsmVtbl {
    ...
    void (*init)(QHsm * const me) reentrant;

    /*! Dispatches an event to a HSM. */
    void (*dispatch)(QHsm * const me) reentrant;
};
...
void QHsm_ctor(QHsm * const me, QStateHandler initial) reentrant;
...
void QHsm_init_(QHsm * const me) reentrant;

/*! Implementation of dispatching events to QHsm. */
void QHsm_dispatch_(QHsm * const me) reentrant;
