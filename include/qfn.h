...
typedef struct {
    ...
    */
    ...
    bool (*post)(QActive * const me, uint_fast8_t const margin,
                 enum_t const sig, QParam const par) reentrant;
...
#define QF_NO_MARGIN ((uint_fast8_t)0xFF)
    ...
    */
    ...
    void QActive_armX(QActive * const me, uint_fast8_t const tickRate,
                      QTimeEvtCtr const nTicks, QTimeEvtCtr const interval) reentrant;
#else
    /*! Arm the QP-nano one-shot time event. */
    void QActive_armX(QActive * const me, uint_fast8_t const tickRate,
                      QTimeEvtCtr const nTicks) reentrant;
#endif
...
extern  uint_fast8_t xdata QF_readySet_;
